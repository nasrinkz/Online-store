                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2">
                            <div class="banner-area__img">
                                <img src="{{asset('dist/images/banner.jpg')}}" alt="banner-img" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="brand-area">
                                <div class="brand-area-image">
                                    <img src="{{asset('dist/images/brand/01.png')}}" alt="Brand" class="img-fluid">
                                </div>
                                <div class="brand-area-image">
                                    <img src="{{asset('dist/images/brand/02.png')}}" alt="Brand" class="img-fluid">
                                </div>
                                <div class="brand-area-image">
                                    <img src="{{asset('dist/images/brand/03.png')}}" alt="Brand" class="img-fluid">
                                </div>
                                <div class="brand-area-image">
                                    <img src="{{asset('dist/images/brand/04.png')}}" alt="Brand" class="img-fluid">
                                </div>
                                <div class="brand-area-image">
                                    <img src="{{asset('dist/images/brand/02.png')}}" alt="Brand" class="img-fluid">
                                </div>
                                <div class="brand-area-image">
                                    <img src="{{asset('dist/images/brand/05.png')}}" alt="Brand" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="features-active">
                            <div class="product-item">
                                ...
                                <div class="product-item-info">
                                    <a href="product-details.blade.php">BERRY TYPE-II: C1N Backpack</a>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 ">
                                <div class="about-area-content-img">
                                    <img src="{{asset('dist/images/feature/medicine.jpg')}}" alt="img" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="product-item">
                                ...
                                <div class="product-item-info">
                                    <a href="product-details.blade.php">PUMA air max 97</a>
                                    <span>$975</span> <del>$999</del>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="product-item">
                                ...
                                <div class="product-item-info">
                                    <a href="product-details.blade.php">Echo Studio. Amazon Echo Studio</a>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product-item">
                                ...
                                <div class="product-item-info">
                                    <a href="product-details.blade.php">Corning Sunglasses for Men.</a>
                                    <span>$175</span> <del>$199</del>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="product-item">
                                ...
                                <div class="product-item-info">
                                    <a href="product-details.blade.php">Canon PowerShot SX540</a>
                                    <span>$175</span> <del>$199</del>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product-item">
                                ...
                                <div class="product-item-info">
                                    <a href="product-details.blade.php">Kauri Marine Blue (Green Sole)</a>
                                    <span>$175</span> <del>$199</del>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="product-item">
                                ...
                                <div class="product-item-info">
                                    <a href="product-details.blade.php">Full Set for photographer</a>
                                    <span>$175</span> <del>$199</del>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="product-item">
                                ...
                                <div class="product-item-info">
                                    <a href="product-details.blade.php">Face Masks,Face Masks of 50 Pack</a>
                                    <span>$175</span> <del>$199</del>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="product-item">
                                ...
                                <div class="product-item-info">
                                    <a href="product-details.blade.php">Fossil Men's Nate Stainless Steel Chronograph Quartz
                                        Watch</a>
                                    <span>$175</span> <del>$199</del>
                                </div>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div class="productcategory text-center">
                                <div class="productcategory-img">
                                    <a href="#"><img src="{{asset('dist/images/categorys/tree dasher.jpg')}}" alt="images"></a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div class="productcategory text-center">
                                <div class="productcategory-img">
                                    <a href="#"><img src="{{asset('dist/images/categorys/wool-shoe.jpg')}}" alt="images"> </a>
                                </div>
                                <div class="productcategory-text">
                                    <a href="#">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div class="productcategory text-center">
                                <div class="productcategory-img">
                                    <a href="#"><img src="{{asset('dist/images/categorys/jumper.jpg')}}" alt="images"></a>
                                </div>
                                <div class="productcategory-text">
                                    <a href="#">
                                        <h6>Jumper</h6>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div class="productcategory text-center">
                                <div class="productcategory-img">
                                    <a href="#"><img src="{{asset('dist/images/categorys/iphone.jpg')}}" alt="images"></a>
                                </div>
                                <div class="productcategory-text">
                                    <a href="#">
                                        <h6>Apple</h6>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div class="productcategory text-center">
                                <div class="productcategory-img">
                                    <a href="#"><img src="{{asset('dist/images/categorys/drone.jpg')}}" alt="images"></a>
                                </div>
                                <div class="productcategory-text">
                                    <a href="#">
                                        <h6>Drone</h6>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div class="productcategory text-center">
                                <div class="productcategory-img">
                                    <a href="#"><img src="{{asset('dist/images/categorys/headphone.jpg')}}" alt="images"></a>
                                </div>
                                <div class="productcategory-text">
                                    <a href="#">
                                        <h6>Headphone</h6>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div class="productcategory text-center">
                                <div class="productcategory-img">
                                    <a href="#"><img src="{{asset('dist/images/categorys/chosma.jpg')}}" alt="images"></a>
                                </div>
                                <div class="productcategory-text">
                                    <a href="#">
                                        <h6>Sunglass</h6>
