...
{{--                            <a href="#">Nika Store</a>--}}
                        ...
                        <div class="menu-icon ml-auto">
                            <ul>
                                <li>
                                    <a @if(Auth::check()) href="{{route('wishList')}}" @else href="{{route('account')}}" @endif>
...
{{--                                        <span class="heart"></span>--}}
                                ...
                                <li>
                                    <a href="@if(Auth::check()) @if(auth()->user()->user_group_id==1){{route('AdminDashboard')}} @else {{route('UserDashboard')}} @endif @else {{route('account')}}@endif"><svg xmlns="http://www.w3.org/2000/svg" width="18"
...
{{--                            <a href="index.html"><img src="{{asset('dist/images/logo/logo.png')}}" alt="logo" /></a>--}}
                        ...
                        <div class="menu-icon">
                            <ul>
                                <li><a @if(Auth::check()) href="{{route('wishList')}}" @else href="{{route('account')}}" @endif>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="20"
                                            viewBox="0 0 22 20">
                                            <g id="Heart" transform="translate(1 1)">
                                                <path id="Heart-2" data-name="Heart"
