...
@section('title','Dashboard | Color Edit')
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card card-info">
                            ...
                            <form method="POST" action="{{route('UpdateColor',['id'=>$value->id])}}">
                                @csrf
                                {{method_field("put")}}
                                <div class="card-body">
                                    ...
                                    <div class="input-group mb-0 mt-4">
                                        <div class="input-group my-colorpicker2">
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="fas fa-square" style="color: {{$value->code}}"></i></span>
                                            </div>
                                            <input type="text" class="form-control" required name="code" value="{{$value->code}}" placeholder="color code">
                                        </div>
                                    </div>
                                    @if($errors->has('code'))
